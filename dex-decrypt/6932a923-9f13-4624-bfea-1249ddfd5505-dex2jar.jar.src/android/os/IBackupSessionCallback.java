...
public interface IBackupSessionCallback extends IInterface {
  void onTaskStatusChanged(int paramInt1, int paramInt2, int paramInt3, String paramString) throws RemoteException;
  ...
  public static abstract class Stub extends Binder implements IBackupSessionCallback {
    ...
    private static class Proxy implements IBackupSessionCallback {
      ...
      public void onTaskStatusChanged(int param2Int1, int param2Int2, int param2Int3, String param2String) throws RemoteException {
...
/* Location:              C:\Users\daimiaopeng\Downloads\pinduoduo_backdoor-main\pinduoduo_backdoor-main\dex\6932a923-9f13-4624-bfea-1249ddfd5505-dex2jar.jar!\android\os\IBackupSessionCallback.class
