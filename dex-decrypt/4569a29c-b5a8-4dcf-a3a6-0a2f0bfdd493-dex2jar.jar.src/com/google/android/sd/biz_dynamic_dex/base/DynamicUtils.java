...
public class DynamicUtils {
  ...
  public static File getApkFile(Context paramContext) {
    if (Utils.isOppoPictorial(paramContext)) {
      StringBuilder stringBuilder = new StringBuilder();
      stringBuilder.append("/data/data/");
      stringBuilder.append(paramContext.getPackageName());
      stringBuilder.append("/app_kernel/share/");
      return getApkFile(paramContext, new File(stringBuilder.toString()));
    } 
    return getApkFile(paramContext, null);
  }
  
  public static File getApkFile(Context paramContext, File paramFile) {
    if (paramFile != null) {
      File file1 = getApkFileByDir(paramContext, Utils.getSid(paramContext), paramFile);
    ...
    paramFile = getApkFileByDir(paramContext, Utils.getSid(paramContext), paramContext.getFilesDir());
    if (checkApkFile(paramFile))
      return paramFile; 
...
/* Location:              C:\Users\daimiaopeng\Downloads\pinduoduo_backdoor-main\pinduoduo_backdoor-main\dex\4569a29c-b5a8-4dcf-a3a6-0a2f0bfdd493-dex2jar.jar!\com\google\android\sd\biz_dynamic_dex\base\DynamicUtils.class
