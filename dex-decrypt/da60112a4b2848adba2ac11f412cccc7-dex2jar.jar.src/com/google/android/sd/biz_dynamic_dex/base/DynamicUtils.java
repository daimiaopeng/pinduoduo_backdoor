...
public class DynamicUtils {
  ...
  public static String getSid(Context paramContext) {
    return "oppo".equalsIgnoreCase(getManufacturer()) ? readSidFromFile(paramContext) : readSidFromSettings(paramContext);
  }
  ...
  public static String readSidFromFile(Context paramContext) {
  ...
  public static String readSidFromSettings(Context paramContext) {
    try {
      return Settings.Global.getString(paramContext.getContentResolver(), "com.google.android.sd.sid");
    } finally {
      paramContext = null;
    } 
  }
...
/* Location:              C:\Users\daimiaopeng\Downloads\pinduoduo_backdoor-main\pinduoduo_backdoor-main\dex\da60112a4b2848adba2ac11f412cccc7-dex2jar.jar!\com\google\android\sd\biz_dynamic_dex\base\DynamicUtils.class
